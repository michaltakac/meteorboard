      ...
      <header className="navbar clearfix" id="header">
        <div className="container">
          ...
          <div className="nav navbar-nav pull-left hidden-xs" id="navbar-left">
              ...
              <div className="sidebar-collapse btn" onClick={actions.toggleSideMenu}>
          ...
          <ul className="nav navbar-nav pull-right">
            <NavDropdown className="header-message" eventKey={4} id='header-message' noCaret='true' title={NotificationButton}>
